...
const { status, countdown = 0 } = defineProps<{ status?: OrderType; countdown?: number }>()
</script>
...
<template>
  <div class="room-status">
    ...
    <div class="end" v-if="status===OrderType.ConsultComplete ||status===OrderType.ConsultCancel"><van-icon name="passed" /> 已结束</div>
  </div>
</template>
